...
(function () {
  ...
  function renderEquipmentFilterOptions() {
    ...
    els.equipPart.innerHTML = '<option value="">全部部位</option>' + parts
      .map((part) => '<option value="' + esc(part) + '"' + (part === state.equipmentPart ? " selected" : "") + ">" + esc(part) + "</option>")
      .join("");
    ...
    els.equipSourced.checked = state.equipmentSourcedOnly;
  }
  ...
  function renderScrollFilterOptions() {
    ...
    els.scrollSuccess.innerHTML = '<option value="">全部成功率</option>' + rates
      ...
      .join("");
    els.scrollSourced.checked = state.scrollSourcedOnly;
  }
  ...
  function bindEvents() {
    ...
    els.equipSourced.addEventListener("change", (event) => {
    ...
    els.scrollSourced.addEventListener("change", (event) => {
  ...
  function init() {
    els = {
      ...
      meta: document.getElementById("ssimBuildMeta"),
      ...
      equipSourced: document.getElementById("ssimEquipSourced"),
      ...
      scrollSourced: document.getElementById("ssimScrollSourced"),
